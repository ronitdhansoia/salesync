        ...
        <AnimatePresence mode="wait">
          ...
          >
            <div className="grid lg:grid-cols-2">
              ...
              {/* Right side - Visual */}
              <div className={`relative bg-gradient-to-br ${features[activeFeature].color} p-12 flex items-center justify-center`}>
                <div className="absolute inset-0 bg-black opacity-10" />
                <div className="relative bg-white rounded-2xl shadow-2xl p-8 transform rotate-3 hover:rotate-0 transition-transform duration-300">
                  <DemoComponent featureIndex={activeFeature} />
                </div>
              </div>
            </div>
          </motion.div>
...
// Demo component
function DemoComponent({ featureIndex }: { featureIndex: number }) {
  if (featureIndex === 0) {
    return (
