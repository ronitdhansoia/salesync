...
export function AnimatedHero() {
  ...
  return (
    <section className="relative min-h-screen overflow-hidden bg-white dark:bg-black transition-all duration-500 ease-in-out">
      {/* Animated background - using CSS animations instead of Framer Motion for better performance */}
      <div className="absolute inset-0">
        <div className="absolute top-0 left-1/4 w-96 h-96 bg-purple-400 dark:bg-purple-600 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-3xl opacity-20 dark:opacity-10 animate-float-slow" />
        <div className="absolute top-1/2 right-1/4 w-96 h-96 bg-blue-400 dark:bg-blue-600 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-3xl opacity-20 dark:opacity-10 animate-float-medium" />
        <div className="absolute bottom-0 left-1/2 w-96 h-96 bg-pink-400 dark:bg-purple-800 rounded-full mix-blend-multiply dark:mix-blend-screen filter blur-3xl opacity-20 dark:opacity-10 animate-float-slower" />
      </div>
      ...
      <div className="relative z-10 container mx-auto px-6 pt-32 pb-20">
        ...
        >
          ...
          <motion.div
            ...
            className="inline-flex items-center gap-2 bg-gradient-to-r from-purple-100 to-blue-100 dark:from-gray-800 dark:to-gray-700 text-purple-800 dark:text-white border border-transparent dark:border-gray-600 px-4 py-2 rounded-full text-sm font-medium mb-8"
          >
            <Sparkles className="h-4 w-4 text-[#7760F9]" />
          ...
          >
            ...
            <button className="group relative inline-flex items-center justify-center px-8 py-4 text-lg font-medium text-gray-900 dark:text-white bg-white dark:bg-gray-800 rounded-xl border-2 border-gray-200 dark:border-gray-600 overflow-hidden transition-all hover:border-gray-300 dark:hover:border-gray-500 hover:bg-gray-50 dark:hover:bg-gray-700 duration-200">
              <span className="relative z-10 flex items-center gap-2">
                Watch Demo
                <div className="w-8 h-8 bg-gray-100 dark:bg-gray-700 rounded-full flex items-center justify-center group-hover:bg-gray-200 dark:group-hover:bg-gray-600 transition-colors">
                  <div className="w-0 h-0 border-l-[6px] border-l-gray-900 dark:border-l-white border-t-[4px] border-t-transparent border-b-[4px] border-b-transparent ml-0.5" />
                </div>
              </span>
            </button>
          </motion.div>
        ...
        >
          {stats.map((stat, index) => (
            ...
            >
              <div className="absolute inset-0 bg-gradient-to-r from-purple-400 to-blue-400 dark:from-purple-600 dark:to-blue-600 rounded-2xl blur-xl opacity-20 group-hover:opacity-30 transition-opacity duration-300" />
              <div className="relative bg-white dark:bg-black rounded-2xl p-6 shadow-lg border border-gray-100 dark:border-gray-900 hover:border-gray-200 dark:hover:border-gray-800 transition-all duration-300 ease-in-out">
