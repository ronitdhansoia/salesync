...
export function WaitlistHeroBeams() {
  ...
  return (
    <section id="waitlist" className="relative min-h-screen w-full bg-white dark:bg-neutral-950 flex flex-col items-center justify-center antialiased overflow-hidden">
